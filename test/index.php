...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Des Moines Adult Hockey - Home</title>
				...
				<div id="main">
					...
					<div id="content">
						<div id="box1">
							...
							<p>
								Welcome to the new Des Moines Adult Hockey page.  Everyone has been asking for more information for quite a while, so here it is.  You'll recognize the <a href="standings.php">standings</a> and <a href="schedule.php">schedule</a> pages, but the new <a href="#">stats</a> pages and team rosters and stats should give you more locker room fodder when chatting with teammates.  Please use the contact page to send me any questions, comments, or suggestions on this new site.
							</p>
						</div>
						<div id="box2">
							<h3>
